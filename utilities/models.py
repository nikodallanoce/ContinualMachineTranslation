...
def get_all_mbart_models() -> Dict[str, MT5ForConditionalGeneration]:
    ...
    mf12_model_joint: MBartForConditionalGeneration = AutoModelForSeq2SeqLM.from_pretrained(
        "/home/n.dallanoce/PyCharm/pretraining/weights/mbart_pre_de_ft_en-fr(Mf1-2)_joint/checkpoint-100000",
        output_attentions=True)
    mf13_model_joint: MBartForConditionalGeneration = AutoModelForSeq2SeqLM.from_pretrained(
        "/home/n.dallanoce/PyCharm/pretraining/weights/mbart_pre_de_ft_en-fr(Mf1-2)_joint_240k/checkpoint-100000",
        output_attentions=True)
    mf2_model_joint: MBartForConditionalGeneration = AutoModelForSeq2SeqLM.from_pretrained(
        "/home/n.dallanoce/PyCharm/pretraining/weights/mbart_ft_en-de-Mf2_joint/checkpoint-100000",
        output_attentions=True)
    mf23_model_joint: MBartForConditionalGeneration = AutoModelForSeq2SeqLM.from_pretrained(
        "/home/n.dallanoce/PyCharm/pretraining/weights/mbart_pre_es_ft_en-de(Mf2-3)_joint_240k/checkpoint-100000",
        output_attentions=True)
    mf3_model_joint: MBartForConditionalGeneration = AutoModelForSeq2SeqLM.from_pretrained(
        "/home/n.dallanoce/PyCharm/pretraining/weights/mbart_ft_en-es(Mf3)_joint_240k/checkpoint-100000",
        output_attentions=True)
    mbart_str2model = {
        "M1": m1_model,
        "M2": m2_model,
...
def get_all_mt6_models() -> Dict[str, MBartForConditionalGeneration]:
    ...
    mt6_mf12_joint = AutoModelForSeq2SeqLM.from_pretrained(
        "/home/n.dallanoce/PyCharm/pretraining/weights/mt6_pre_de_ft_en-fr(MF1-2)_joint/checkpoint-100000",
        output_attentions=True)

    mt6_mf13_joint = AutoModelForSeq2SeqLM.from_pretrained(
        "/home/n.dallanoce/PyCharm/pretraining/weights/mt6_pre_es_ft_en-fr-MF3-1_joint_240k/checkpoint-30000",
        output_attentions=True)

    mt6_mf23_joint = AutoModelForSeq2SeqLM.from_pretrained(
        "/home/n.dallanoce/PyCharm/pretraining/weights/mt6_pre_es_ft_en-de(MF2-3)_joint_240k/checkpoint-100000",
        output_attentions=True)

    mt6_mf2_joint = AutoModelForSeq2SeqLM.from_pretrained(
        "/home/n.dallanoce/PyCharm/pretraining/weights/mt6_ft_en-de(MF2)_joint/checkpoint-100000",
        output_attentions=True)

    mt6_mf3_joint = AutoModelForSeq2SeqLM.from_pretrained(
        "/home/n.dallanoce/PyCharm/pretraining/weights/mt6_ft_en-es(MF3)_joint_240k/checkpoint-90000",
        output_attentions=True)

    mt6_pre_de_only = AutoModelForSeq2SeqLM.from_pretrained(
        "/home/n.dallanoce/PyCharm/pretraining/weights/mt6_pre_en-de_20_20_tb/checkpoint-180000",
        output_attentions=True)

    mt6_ft_only_en_de = AutoModelForSeq2SeqLM.from_pretrained(
        "/home/n.dallanoce/PyCharm/pretraining/weights/mt6_ft_only_en-de_ft_only_tb/checkpoint-90000",
        output_attentions=True)
