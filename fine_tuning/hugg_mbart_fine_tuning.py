...
def run_server():
    ...
    return training_args, translation_ds
...
if __name__ == '__main__':
    ...
    training_args, translation_ds = run_local()
    translation_ds = MBartTranslationDataset(translation_ds, tok_en, "fr", input_max_length=64)
